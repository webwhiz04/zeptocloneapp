...
const API_URL = `${BASE_URL}/api/products?category=electronics`;
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                setProducts(list.filter((item) => Array.isArray(item.categories) && item.categories.includes("electronics")));
            } catch (error) {
