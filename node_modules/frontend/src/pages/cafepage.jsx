...
const API_URL = `${BASE_URL}/api/products?category=cafe`;
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                setProducts(list.filter((item) => Array.isArray(item.categories) && item.categories.includes("cafe")));
            } catch (error) {
                console.error("Error fetching cafe products:", error);
                setProducts([]);
            } finally {
                setLoading(false);
            }
